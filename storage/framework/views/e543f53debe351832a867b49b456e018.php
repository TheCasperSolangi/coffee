<div
    ...
    data-payment-intent-secret="<?php echo e($paymentMethod->createOrFetchIntent($order)); ?>"
    data-stripe-options='<?php echo json_encode($paymentMethod->getStripeJsOptions($order), 15, 512) ?>'
...
>
    ...
    <div class="form-group">
        ...
        <?php else: ?>
            ...
            <?php if($paymentMethod->supportsPaymentProfiles() && $order->customer): ?>
